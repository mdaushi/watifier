                ...
                <table class="table table-vcenter">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="td-truncate">
                        <div class="text-truncate">Some minor text tweaks</div>
                      </td>
                  ...
                  <div class="col-10">
                    ...
                    <div class="markdown text-muted">
                      ...
                      <a
                        ...
                        rel="noopener"
                        >tabler-icons.io</a
                      >, download any of the 1960 icons in SVG, PNG
              ...
              <div class="table-responsive">
                <table class="table card-table table-vcenter">
                  ...
                  <tr>
                    ...
                    <td class="w-100">
                      <a href="#" class="text-reset"
                        >Database backup and maintenance</a
                      >
                    </td>
                    <td class="text-nowrap text-muted">
                      <!-- Download SVG icon from http://tabler-icons.io/i/calendar -->
                  ...
                  <tr>
                    ...
                    <td class="w-100">
                      <a href="#" class="text-reset"
                        >Identify the implementation team.</a
                      >
                    </td>
                    <td class="text-nowrap text-muted">
                      <!-- Download SVG icon from http://tabler-icons.io/i/calendar -->
                ...
                >
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>2 Sep 2017</td>
                      <td>
                        <span class="badge bg-secondary me-1"></span> Due in 2
                        Weeks
                      </td>
                      <td>$1500</td>
                      <td class="text-end">
                    ...
                    <tr>
                      ...
                      <td>4 Feb 2018</td>
                      <td>
                        <span class="badge bg-secondary me-1"></span> Due in 3
                        Weeks
                      </td>
                      <td>$300</td>
                      <td class="text-end">
